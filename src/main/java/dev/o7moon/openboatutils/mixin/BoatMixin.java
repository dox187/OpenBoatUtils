...
public abstract class BoatMixin implements GetStepHeight, GetNearbySetting {
    ...
    *///? }
    ...
    private void redirectYawVelocityIncrement(Boat instance, float deltaRotation) {
        @Nullable ISettingContext context = OpenBoatUtils.instance.getActiveContext();
    ...
    @Unique
    private void openboatutils$applyLateralSlipperiness(Boat boat, float slipperiness) {
    ...
    @Unique
    private void openboatutils$applyBrakeSlipperiness(Boat boat, float slipperiness) {
        Vec3 velocity = boat.getDeltaMovement();
    ...
    @Unique
    private void openboatutils$applyMaxSpeedResistance(Boat boat, float maxSpeed, float maxSpeedResistance) {
        Vec3 velocity = boat.getDeltaMovement();
